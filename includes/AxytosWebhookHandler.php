...
class AxytosWebhookHandler {
	...
	public function register_webhook_endpoint(): void {
		register_rest_route(
			...
			array(
				...
				'permission_callback' => array( $this, 'authenticate_webhook_request' ),
				'args'                => array(
					'order_id'        => array(
						'required'          => true,
						'type'              => 'integer',
	 ...
	 */
	private function log_webhook_activity( $level, $message, $context = array() ): void {
